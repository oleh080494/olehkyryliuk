...
function Skills() {
  ...
  const technicalSkills = [
    [
      "Web technologies (HTML, CSS -> Tailwind, JavaScript -> React + Node.js, REST APIs)",
    ...
    [
      ...
      "Used Git and GitHub for collaborative coding, managing branches, and handling version history.",
    ],
    [
      "Spotify API integration & external APIs",
      "Integrated external APIs, including Spotify API, to build dynamic and interactive web experiences.",
    ],
    [
  ...
  const softSkills = [
    [
      ...
      "Worked effectively in multicultural, interdisciplinary teams across various academic and design projects.",
    ],
    [
      "Effective group project management",
      "Coordinated tasks, tracked progress, and ensured timely delivery of project milestones.",
    ],
    [
      "Clear communication of technical concepts",
      "Explained complex ideas in accessible ways to both technical and non-technical audiences.",
    ],
    [
      "Creative problem solving & innovation",
      "Approached challenges with out-of-the-box thinking and prototyped original solutions.",
    ],
    [
      "Identifying user needs and building solutions",
      "Researched user behavior and designed products that address real needs and improve user experience.",
    ],
    [
      "Critical and reflective thinking",
      "Evaluated design and technical decisions with a focus on impact, trade-offs, and long-term value.",
    ],
    [
      "Awareness of ethical and social implications of tech",
      "Considered how technology affects privacy, fairness, and sustainability in design processes.",
    ],
    [
      "Adaptability & fast learner",
      "Quickly learned new tools, programming languages, and frameworks as projects required.",
    ],
    [
      "Independent and collaborative working",
      "Balanced solo work and team collaboration efficiently to achieve high-quality project outcomes.",
    ],
  ];
